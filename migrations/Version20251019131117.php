 ...
 */
final class Version20251019131117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE task (id SERIAL NOT NULL, owner_id INT NOT NULL, title VARCHAR(255) NOT NULL, is_done BOOLEAN NOT NULL, due_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, PRIMARY KEY(id))');
